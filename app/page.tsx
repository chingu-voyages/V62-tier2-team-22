		...
		<div className="bg-[#040914] text-white min-h-screen bg-grid-pattern relative overflow-hidden">
			...
			<div className="max-w-6xl mx-auto px-6 pt-16 pb-24 relative z-10">
				...
				<div className="flex flex-wrap items-center gap-4 mb-16">
					<Link href="/career" className="bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-semibold px-6 py-3.5 rounded-md flex items-center gap-2 transition cursor-pointer">
